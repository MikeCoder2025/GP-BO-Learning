...
st.title("Optimisation Accelerator Programme: Introduction to Bayesian Optimisation")

st.caption(
    "Interactive learning software for Gaussian Processes, Bayesian Optimisation, "
    "multi-objective optimisation and experimental design."
)
...
st.markdown(
    """
    Use the tabs below to move from the fundamentals of Gaussian Processes
    to Bayesian Optimisation, Pareto analysis, the pharmaceutical case study,
    and finally your own experimental dataset.
    """
)
